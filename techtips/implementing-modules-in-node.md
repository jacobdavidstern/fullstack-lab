#### Implementing Modules in Node (from Codecademy Intermediate JavaScript)
...
Notes: 
argv[2] syntax in example is valid for interactive command line only.
Direct function import is most clean and concise.